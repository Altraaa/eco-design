      ...
      <section className="py-20 bg-custom-gray3/5">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-serif text-custom-gray1 mb-4">
              MANFAAT PENGGUNAAN VEGETASI
            </h2>
            <p className="text-custom-gray4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-custom-gray3/20"
              >
                <h3 className="text-xl font-serif text-custom-gray1 mb-4">
                  {benefit.title}
                </h3>
                <p className="text-custom-gray4">{benefit.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
